...
const Add = () => {
  ...
  return (<div className='mx-auto h-[85%] sm:h-[80%] font-quicksand'>
    <div className='w-[70vw] sm:w-[52vw] h-[100%] bg-[#7876a0] mx-auto rounded-[10px] px-[10px] sm:px-[20px] py-[10px] text-white'>
      <div className=''>
        ...
        <div className='flex gap-1 sm:gap-2  items-center'>
          ...
          <button onClick={Addtodo} className='bg-[black] text-white h-[35px] w-[70px] rounded-[20px] cursor-pointer hover:scale-110'>Submit</button>
        </div>
      </div>
      ...
      <div className='mx-[4px] h-[70%]'>
        <div className='font-bold text-[#0f0f1f]'>Your Todos</div>
        <div className='  h-[90%]'>
